...
namespace BloodHunter.Common.UI.InitiateBloodHunterUI
{
    public class InitiateBloodHunterUISystem : ModSystem
    {
        internal InitiateBloodHunterUIState barActive;

        private UserInterface _barActive;

        public override void Load()
        {
            barActive = new InitiateBloodHunterUIState();
            barActive.Activate();
